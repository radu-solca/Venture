...
{
    public class JoinTeamCommandHandler : ICommandHandler<JoinTeamCommand>
    {
        private readonly IRepository<Team> _teamRepository;

        public JoinTeamCommandHandler(IRepository<Team> teamRepository)
        {
            Guard.AgainstNullArgument(nameof(teamRepository), teamRepository);
            _teamRepository = teamRepository;
        }

        public void Handle(JoinTeamCommand command)
        {
